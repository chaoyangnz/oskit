...
__arch_copy_from_user(void *to, const void *from, unsigned long n)
{
	memcpy(to, from, n);
	return 0;	/* Totally stupid */
}
#else
...
#ifdef OSKIT
static inline unsigned long
__arch_copy_to_user(void *to, const void *from, unsigned long n)
{
	memcpy(to, from, n);
	return 0;	/* Totally stupid */
}
