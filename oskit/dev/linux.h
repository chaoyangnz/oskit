...
/* Initialize one or more entropy devices */
oskit_error_t oskit_linux_init_entropy(void);
oskit_error_t oskit_linux_init_entropy_random(void);
...
oskit_error_t oskit_linux_init_randompool(void);
...
oskit_error_t oskit_linux_init_randompools(void);
